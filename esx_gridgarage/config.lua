Config = {
	Locale = "en",
	DrawDistance = 100,
	Price = 0, -- You may change this to your liking!
	-- Script by Grid_Gaming
	-- This is the multiplier of price they will pay
	RepairMultiplier = 1, 
...
--change to your liking. MUST have proprer cords for this to work.
Config.Garages = {
